...
CREATE TABLE `albums` (
  ...
  `singers` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `banner` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `dreamer_upload` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `first` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `last` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `movies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `actors` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `duration` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `banner` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_created` date NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `slides` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `image_name` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trailers` (
  ...
  `trailer_name` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `user_pass` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`user_id`),
...
CREATE TABLE `webseries_trailer` (
  ...
  `wb_trailer_name` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
