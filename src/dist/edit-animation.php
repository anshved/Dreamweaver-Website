        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" id="animation-description" name="animation-description" rows="9" placeholder="Description.."><?php echo $animation['description'] ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
