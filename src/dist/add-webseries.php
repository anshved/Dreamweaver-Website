    ...
    <div class="col-md-8 offset-md-3 mt-5">
        <div class="card">
            <div class="card-header">
                <strong>Add webseries</strong>
            </div>
            <?php
        $url = "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
        if(strpos($url, "status=success") !== false) {
            echo '<div class="alert alert-success" role="alert">
                    Webseries Added Successfully
                </div>';
        ...
        ?>
            <div class="card-body">
                <form class="form-horizontal" action="../includes/add_webseries.inc.php" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="webseries-name-input">Webseries Name</label>
                        <div class="col-md-9">
                            <input class="form-control" id="webseries-name" type="text" name="webseries-name" placeholder="Enter Webseries Name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="text-input">Actors</label>
                        <div class="col-md-9">
                            <input class="form-control" id="webseries-actors" type="text" name="webseries-actors" placeholder="Shahrukh Khan, Amitabh Bacchan,...">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" id="webseries-date" type="date" name="webseries-date" placeholder="Date of Release">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="webseries-description-input">Description</label>
                        <div class="col-md-9">
                            <textarea class="form-control" id="webseries-description" name="webseries-description" rows="9" placeholder="Description.."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" id="webseries-season" name="webseries-season" placeholder="Seasons">
                        </div>
                    </div>
                    <div class="form-group row">
