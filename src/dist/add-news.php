...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    ...
    <!-- sidebar end -->
        ...
        <div class="card">
            ...
            ?>
            <div class="card-body">
                <form class="form-horizontal" action="../includes/add_news.inc.php" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="news-headline-input">Headline</label>
                        <div class="col-md-9">
                            <input class="form-control" id="news-headline" type="text" name="news-headline" placeholder="Enter Headline">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="news-description-input">Description</label>
                        <div class="col-md-9">
                            <textarea class="form-control" id="news-description" name="news-description" rows="9" placeholder="Description.."></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
