<?php include_once 'templates/oldnavbar.php' ?>
  ...
  <section id="portfolio">
    <div class="container wow fadeInUp">
      ...
      <div class="action col-md-offset-2 row">
        <a href="">
          <button class="col-xs-5 col-md-2 btn-register" onclick="" type="submit" name="submit">All</button>
        </a>
        <a href="">
          <button style="padding-left: 0; padding-right: 0;" class="col-xs-5 col-md-2 btn-register" onclick="" type="submit" name="submit">Completed</button>
        </a>
        <a href="">
          <button class="col-xs-5 col-md-2 btn-register" onclick="" type="submit" name="submit">Ongoing</button>
        </a>
        <a href="">
          <button style="padding-left: 0; padding-right: 0;" class="col-xs-5 col-md-2 btn-register" onclick="" type="submit" name="submit">Forthcoming</button>
        </a>
